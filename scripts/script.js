...
function lancerJeu() {
    ...
    console.log(listeProposition, "init")
    ...
    btnValiderMot.addEventListener("click", () => {
        ...
        inputEcriture.value = ''
        console.log(listeProposition[i], "inee")
...
function congrats(){
    // Nombre de fleurs à afficher
const numberOfFlowers = 10;

// Récupérer le conteneur des fleurs
const flowersContainer = document.getElementById('flowers-container');

// Créer les fleurs et les ajouter au conteneur
...
setInterval(() => {
  ...
  for (let i = 0; i < flowers.length; i++) {
    ...
    const currentTop = parseInt(flower.style.top) || 0;
    flower.style.top = (currentTop + 1) + 'px'; // Faites descendre la fleur d'un pixel
  }
}, 10); // Mettre à jour la position toutes les 10 millisecondes
}
